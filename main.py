...
chemin = "C:/Users/jxue0/Desktop/tipe/tipe_jenny/dataset_num2/base de donnees/"
...
def point_aleatoire(r,L,l):
    ...
    return creation_image_balle_noir(i,j,r,L,l),i,j
...
def trier_images_par_x_direct(dossier_source, dossier_destination):
    ...
    # 1. Création automatique des 3 dossiers cibles s'ils n'existent pas
    categories = {
        "gauche": dest_dir / "gauche",
        "milieu": dest_dir / "milieu",
        "droite": dest_dir / "droite",
        "gauche_extr": dest_dir / "gauche_extr",
        "droite_extr": dest_dir / "droite_extr",
    }

    for cat_folder in categories.values():
        cat_folder.mkdir(parents=True, exist_ok=True)

    # 2. Parcours des fichiers .png du dossier source
